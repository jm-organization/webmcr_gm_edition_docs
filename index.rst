...
В |mcr| была интегрирована поддержка стандартов автозагрузки файлов. Вам не нужно беспокоиться 
о том, будет ли загружен ваш класс. Также, это дало возможность использовать сторонние php-библиотеки, 
к примеру, `FastRoute`_, котороя используется в |mcr| для маршрутизации. 
